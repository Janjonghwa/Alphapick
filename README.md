...
|------|-----------|------|----------|
| `[팀원 이름 입력]` | Jonghwa Park | `[역할 입력]` | `[담당 기능 입력]` |
| `[팀원 이름 입력]` | kjm0603 (KJM0603) | `[역할 입력]` | `[담당 기능 입력]` |

> ⚠️ 저장소 문서에서 팀원별 구체적인 역할과 담당 기능을 확인할 수 없어 위 표의 이름/역할/담당 업무는 팀원이 직접 채워야 합니다.
...
- Vue 3 프론트엔드 대시보드, 종목 리포트 UI 구현
- Lightweight Charts 기반 캔들스틱 차트 연동
- 커뮤니티(게시글/댓글/팔로우/알림) 기능 구현
- 사용자 인증(JWT) 및 프로필 관리
