...
| 화면 | 경로 | 설명 |
|---|---|---|
| 기본 대시보드 | `/` | 기준일, 투자 성향 선택, 편입 종목 상위 15개 |
| 오늘의 포트폴리오 | `/portfolio` | 편입 종목 전체 목록, 점수, 비중, 추천 사유 |
| 종목 검색 | `/stocks` | 종목 검색, 점수/테마 필터, 리포트 이동 |
...
| ID | 기능 | 우선순위 | 수용 기준 |
|---|---|---|---|
| F-01 | 기본 대시보드 | 필수 | 기준일, 투자 성향 선택, 편입 종목 상위 15개가 표시된다. |
| F-02 | 오늘의 포트폴리오 전체 | 필수 | 편입 종목 전체가 테이블로 표시된다. |
| F-03 | 투자 성향 변경 | 필수 | 중립형, 공격형, 안정형 선택 시 포트폴리오가 재조회된다. |
| F-04 | 종목 검색 | 필수 | 종목명/티커, 점수, 섹터 그룹, 2차 테마로 종목을 필터링하고 리포트로 이동할 수 있다. |
...
| GET | `/api/themes/` | 종목 검색용 섹터·테마 목록 조회 | 선택 |
