...
1. 기본 대시보드 홈에서 데이터 기준일, 투자 성향, 편입 종목 TOP 15 확인
...
- [API.md](API.md): 화면별 API 매핑과 엔드포인트 명세
- [EXTERNAL_APIS.md](EXTERNAL_APIS.md): 외부 데이터/API 연동 현황과 후보
