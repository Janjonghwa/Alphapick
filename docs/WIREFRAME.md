...
|                           | - report button                 |
+---------------------------+---------------------------------+
| Watch candidates TOP 5    | Backtest summary                |
+-------------------------------------------------------------+
```
...
```txt
+-------------------------------------------------------------+
| Stock name / ticker / sector / capture                      |
+-------------------------------------------------------------+
| Big diagnosis headline                                      |
| PER / ROE / foreign flow / current price                    |
+--------------+--------------+--------------+---------------+
| Trend card   | Momentum     | Volatility   | Flow          |
+-------------------------------------------------------------+
...
```txt
+-------------------------------------------------------------+
| Portfolio return | KOSPI return | Win rate | Max drawdown   |
+-------------------------------------------------------------+
| Cumulative return chart                                     |
+-------------------------------------------------------------+
| Daily rebalance table                                       |
+-------------------------------------------------------------+
```
